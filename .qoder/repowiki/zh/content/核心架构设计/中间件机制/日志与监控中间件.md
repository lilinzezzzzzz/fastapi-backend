...
## 更新摘要
**变更内容**
- 新增 `write_to_console` 参数说明，支持独立控制日志输出到控制台
- 更新日志系统UTC时间处理标准化机制
- 修订日志管理器初始化和配置流程
...
- [async_logger.py](file://pkg/async_logger.py#L18-L287)
...
- [async_logger.py](file://pkg/async_logger.py#L272-L273)
- [logger.py](file://internal/core/logger.py#L57-L58)
...
**图表来源**
- [async_logger.py](file://pkg/async_logger.py#L78-L89)
...
**章节来源**
- [async_logger.py](file://pkg/async_logger.py#L205-L268)
...
- [async_logger.py](file://pkg/async_logger.py#L1-L9)
